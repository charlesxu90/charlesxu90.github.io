...
原课程B站地址：[https://www.bilibili.com/video/BV1zv41177JQ](https://www.bilibili.com/video/BV1zv41177JQ)

笔记来源：[https://blog.csdn.net/weixin_43093481/article/details/119299915](https://blog.csdn.net/weixin_43093481/article/details/119299915)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011630913.png)
或 

![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011633105.png)
#### 注意事项
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011635441.png)
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011637627.png)
#### (2) 图表(Graphs)：
...
* 折线图：用于展示随时间变化的趋势 Used to show trends over time, age, or dose (can display group means or individuals)![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011640633.png)

* 柱状图：用于同一时间点不同类别数据间比较。简单直观，易于理解 Used to compare groups at one time point; tells a quick visual story ![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011642908.png)最好能显示数值

* 散点图：表示两变量间的关系，如线性关系。包含各独立数据信息，信息密度较大 Used to show relationships between two variables (particularly linear correlation); Allows reader to see individual data points=more information!![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011644369.png)

   * 反例，散点图中的线会产生误导性，要小心使用。![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011646965.png)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011648470.png)
反例2:

* 图中展示了太多信息，且无法从图中直接看到 pattern。不如转成表格。

![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011651206.png)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011653541.png)
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011655975.png)
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011658200.png)
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011700427.png)
#### (4) 其他补充材料：

在论文投稿时，可以在附加中添加视频等其他材料，编辑很乐于接受这些补充材料！

![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011702729.png)
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011705679.png)
### 2.2 结果 (Results) (L5.2)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011708292.png)
##### Original：
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011710580.png)
##### Original:
...
* (3) 给出尽可能完整的信息，但同时要简单易读，不要过于复杂。常用方法：
   ...
   * c. 用流程图或表格等方式展现：简洁直观，易于理解![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011712056.png)
...
* 通用原则：who、what、when、where、how、why![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011714675.png)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011716550.png)
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011718437.png)
* 回答问题：回答在导入部分提出的假设
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011720253.png)
#### 技巧：
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011722704.png)![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011725385.png)
...
[https://www.exploratorium.edu/origins/coldspring/printit.html](https://www.exploratorium.edu/origins/coldspring/printit.html)
...
* Not Parallel:Bates describes the five principles for the success of decision support systems in clinical settings: speed, real-time delivery, integration into workflow, simplicity and **to avoid**data entry.
...
* 在必须使用缩写时，确保在**文章每个部分都重新给出缩写的定义**，因为读者可能跳读
...
![图片](https://xux-zotero-img.oss-cn-beijing.aliyuncs.com/img/20260613011727612.png)
...
* Books on scientific writing:
   ...
   * Successful Scientific Writing: A Step-by-Step Guide for the Biological and Medical Sciences, Matthews and Matthews

   * Guidebook to better medical writing, RobertIles

   * Scientific writing and communication, Angelika Hofmann. 

   * Clinical Chemistry Guide to Scientific Writing: [http://www.aacc.org/publications/clin_chem/ccgsw/Pages/default.aspx#](http://www.aacc.org/publications/clin_chem/ccgsw/Pages/default.aspx#)

* Articles on scientific writing:

   * [http://www.aacc.org/publications/clin_chem/ccgsw/Pages/default.aspx#](http://www.aacc.org/publications/clin_chem/ccgsw/Pages/default.aspx#) 
...
* Editorials:
   ...
   * Friedman GD. Be kind to your reader. Am J Epidemiol. 1990 Oct; 132(4): 591-3.
